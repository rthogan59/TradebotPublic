...
#Initial Tutorial: https://www.youtube.com/watch?v=4fRAuWHPCPE&t=1670s
#This file provides functions to buy and sell coins on PancakeSwap
...
def buyToken(contractAddress,buyAmount):
    bsc = "https://bsc-dataseed.binance.org/"
    web3 = Web3(Web3.HTTPProvider(bsc))
    print(web3.isConnected())

    #My wallet address
    sender_address = '0xBc93f1b65623cA4B395b8B766844Fd85B51Bc1B7'
    ...
    #Contract address of token you want to buy
    tokenToBuy = web3.toChecksumAddress(contractAddress)
    
    #WBNB contract address
    wbnb = web3.toChecksumAddress('0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c')

    #Create nonce based on transaction count
    nonce = web3.eth.get_transaction_count(sender_address)

    start = time.time()
    #print(contract.functions.allowance())

    pancakeswap2_txn = contract.functions.swapExactETHForTokens (
        0, #Minimum amount of tokens you want to receive
        [wbnb,tokenToBuy],
        sender_address,
        (int(time.time()) + 10000)
    ).buildTransaction({
        'from': sender_address,
        'value': web3.toWei(buyAmount,'ether'), #The BNB amount you want to swap from 
        'gas': 1000000,
        'gasPrice': web3.toWei('5','gwei'),
        'nonce': nonce,
    })

    signed_txn = web3.eth.account.sign_transaction(pancakeswap2_txn,'Private Key')

    tx_token = web3.eth.send_raw_transaction(signed_txn.rawTransaction)
    print(web3.toHex(tx_token))
    
def sellToken(contractAddress):
    bsc = "https://bsc-dataseed.binance.org/"
    web3 = Web3(Web3.HTTPProvider(bsc))
    print(web3.isConnected())
    ...
    coinToSell = web3.toChecksumAddress(contractAddress)

    sellTokenContract = web3.eth.contract(coinToSell, abi=sellAbi)

    #Get current balance of coin
    ...
    print(web3.eth.get_transaction_count(sender_address))
    ...
    signed_txn = web3.eth.account.sign_transaction(approve,'Private Key')
...
#sellToken('0x678e840c640f619e17848045d23072844224dd37')
